...
And answer the following questions about them:
  ...
  * These repositories are at two different websites - github and bitbucket - what are these sites?  What service do they provide? Which is better?
  GitHub and Bitbucket are cloud-based platforms for hosting Git repositories. They provide user-friendly interfaces to visualize repository contents and offer CI/CD pipelines for automating software builds and deployments. GitHub is popular for open-source projects, while Bitbucket integrates well with Atlassian tools like Jira. Both are excellent choices, and the best one depends on your specific needs.
  ...
  * Are either/both of these projects active at the moment? 🤔 If not, what do you think happened?
  Not active at the moment because the most recent commits for both are few years ago. The people writing these project have probably moved on to do something else.
  * 🤔 Which file in each project has had the most activity? 
  The git one had the most activity.
